...
import (
	...
	// files.
	"github.com/ozanturksever/nrpc/examples/helloworld-customsubject/helloworld"
)
...
func TestBasic(t *testing.T) {
	...
	h := helloworld.NewGreeterHandler(context.TODO(), "test", nc, s)
	...
	cli := helloworld.NewGreeterClient("test", nc)
