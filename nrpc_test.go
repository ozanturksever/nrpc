...
func TestStreamCall(t *testing.T) {
	...
	t.Run(
		"Simple stream", func(t *testing.T) {
			subn, err := nc.Subscribe(
				"foo.*", func(m *nats.Msg) {
...
func TestMarshal(t *testing.T) {
	for _, tt := range encodingTests {
		t.Run(
			"Marshal"+tt.encoding, func(t *testing.T) {
...
func TestUnmarshal(t *testing.T) {
	for _, tt := range encodingTests {
		t.Run(
			"Unmarshal"+tt.encoding, func(t *testing.T) {
...
func TestMarshalUnmarshalResponse(t *testing.T) {
	for _, tt := range encodingTests {
		t.Run(
			"UnmarshalResponse"+tt.encoding, func(t *testing.T) {
				var msg DummyMessage
		...
		t.Run(
			"MarshalErrorResponse"+tt.encoding, func(t *testing.T) {
				data, err := nrpc.MarshalErrorResponse(
					tt.encoding, &nrpc.Error{
...
func compareStringSlices(t *testing.T, expected, actual []string) {
	if len(expected) != len(expected) {
		t.Errorf(
			"String slices are different. Expected [%s], got [%s]",
...
func TestParseSubject(t *testing.T) {
	for i, tt := range []struct {
		...
		{
			"demo", 2, "foo", 1, 0, "demo.p1.p2.foo.sp1.bar.json", []string{"p1", "p2"}, []string{"sp1"}, nil, "bar",
			"json", "",
		},
		{
